...
namespace sistemaeducativo.Controllers
{
    ...
    public class MatriculasController : Controller
    {
        ...
        public MatriculasController(SistemaeducativoContext context)
        {
            _context = context;
        }
        ...
        {
            var sistemaeducativoContext = _context.Matriculas.Include(m => m.Curso).Include(m => m.Estudiante);
            return View(await sistemaeducativoContext.ToListAsync());
        }
