...
namespace sistemaeducativo.Controllers
{
    ...
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(SistemaeducativoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EstudianteId,Nombre,Apellido,FechaNacimiento,Email")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstudianteId,Nombre,Apellido,FechaNacimiento,Email")] Estudiante estudiante)
        {
